...
def guest_menu():
    ...
    if not os.path.isfile(file_name):
        ...
        guest_dict = {}
        guest_dict.update({sign_mail:Guest(sign_name, sign_mail, sign_address,password)})
        ...
        guest_data.update({sign_mail:Guest(sign_name, sign_mail, sign_address,password)})
